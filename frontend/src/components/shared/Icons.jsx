...
export function ContactNavIcon({ size = 16, ...props }) {
  return (
...
export function DonateNavIcon({ size = 16, ...props }) {
  return (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="none" aria-hidden="true" {...props}>
      <path
...
export function RedditIcon({ size = 22, ...props }) {
  return (
...
export function DiscordIcon({ size = 22, ...props }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" {...props}>
...
export function EmailIcon({ size = 22, ...props }) {
  return (
...
export function CoffeeIcon({ size = 26, ...props }) {
  return (
...
export function DragHandleIcon({ size = 10, ...props }) {
  return (
    <svg width={size} height={Math.round(size * 1.6)} viewBox="0 0 10 16" fill="currentColor" {...props}>
...
export function ArchiveIcon({ size = 11, ...props }) {
  return (
...
export function RestoreIcon({ size = 11, ...props }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <polyline points="1 4 1 10 7 10" />
      <path d="M3.51 15a9 9 0 1 0 .49-3.86" />
